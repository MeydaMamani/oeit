                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <marquee width="100%" direction="left" height="18px">
                                <p class="font-10 text-primary"><b>Fuente: </b> BD Padrón Nominal con Fecha [[ date_pn ]] a las 08:30 horas</p>
                            </marquee>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="info-box elevation-2 p-1" id="all">
                                    <div class="info-box-content">
                                        <div id="info" class="d-flex justify-content-center align-items-center">
                                            <button class="btn btn-sm btn-outline-light" @click="listNoSuple">Ver</button>
                                        </div>
                        ...
                        <div class="col-md-1 col-sm-4 text-center p-1">
                            ...
                            <button class="btn btn-outline-primary m-1 btn-sm mb-2 font-11" @click="listSuplementado"><i class="fa fa-check"></i> Ver Todo</button>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div id="table_resume">
                                    ...
                                    <form method="post" id="formulario">
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="d-flex justify-content-center">
                                                <button class="btn btn-primary btn-sm m-1 font-11" id="search" type="button" @click="listSuplementado"><i class="fa fa-search"></i> Buscar</button>
                                ...
                                <table id="demo-foo-addrow2" class="table table-hover table-striped" data-page-size="20" data-limit-navigation="10">
                                    <thead>
                                        <tr class="font-10 text-center" style="background: #e0eff5;">
                                            ...
                                            <th class="align-middle" id="fields_4_meses_head">Documento</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(format, key) in lists" class="font-10">
                                            ...
                                            <td class="align-middle text-center">[[ format.EESS_ATENCION ]]</td>
                                            ...
                                            <td class="align-middle text-center">[[ format.ULTIMA_ATE_PN ]]</td>
