        ...
        <section class="content">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-8">
                            <h5 class="mb-0">Niños 4 Meses CG04 - <span class="name_mes">[[ nameMonth ]]</span> <span class="name_anio">[[ anio ]]</span></h5>
                        </div>
                        <div class="col-sm-4">
                            <ol class="breadcrumb float-sm-right font-14">
                                ...
                                <li class="breadcrumb-item active">4 Meses</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-2 pl-3"><br>
                            <div class="card p-0">
                                <div class="card-body p-1 text-center">
                                    <input type="text" class="knob" id="avance" value="0" data-width="90" data-height="90" data-fgColor="#add" data-readonly="true">
