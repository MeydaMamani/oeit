...
@section('content')
    <div class="content-wrapper" id="appTmz">
        <section class="content">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-8">
                            <h5 class="mb-0">Tamizaje Neonatal CG03 - Mayo 2022</h5>
                        </div>
                        <div class="col-sm-4">
                            <ol class="breadcrumb float-sm-right font-14">
                                ...
                                <li class="breadcrumb-item active">Tmz Neonatal</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-sm-4 text-center p-1">
                            <form action="print_pr3m4tur0.php" method="POST">
                                ...
                                <button type="submit" id="export_data" name="exportarCSV" class="btn btn-outline-success m-1 btn-sm mb-2 font-11"><i class="fa fa-print"></i> Imprimir</button>
                            </form>
                                ...
                                <div class="card-body p-2">
                                    <form method="post" id="formulario">
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control" style="width: 100%;" name="red" id="red" v-model="red" @change="filtersDistricts">
                                                <option value="">Seleccione Red</option>
                                                <option v-for="format in provinces" :value="format.Codigo_Red">[[ format.Red ]]</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2" data-dropdown-css-class="select2-danger" style="width: 100%;" v-model="red" name="distrito" id="distrito">
                                                <option value="">Seleccione Distrito</option>
                                                <option v-for="format in districts" :value="format.Distrito">[[ format.Distrito ]]</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2" data-dropdown-css-class="select2-primary" style="width: 100%;" name="anio" id="anio">
                                        ...
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2" data-dropdown-css-class="select2-primary" style="width: 100%;" name="mes" id="mes">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 pl-3"><br>
                            <div class="card p-0">
                                <div class="card-body p-1 text-center">
                                    <input type="text" class="knob" id="avance" value="80" data-width="90" data-height="90" data-fgColor="#add" data-readonly="true">
                        ...
                        <div class="col-md-10 mb-1">
                            <div id="mitable_all" class="text-center">
                                <div class="table-responsive table_all" id="tmz_neonatal">
                                    <table id="demo-foo-addrow2" class="table table-hover table-striped" data-page-size="20" data-limit-navigation="10">
                                        <thead>
                                            ...
                                            <tr class="font-10 text-center" style="background: #e0eff5;">
                                                ...
                                                <th class="align-middle border" id="color_prematuro_head">Menor Encontrado</th>
                                                <th class="align-middle border" id="color_prematuro_head">Tipo de Seguro</th>
                                                <th class="align-middle border" id="color_prematuro_head">Nombre ESS Nacimiento</th>
                                        ...
                                        <tbody>
                                            <tr v-for="(format, key) in lists" class="font-10">
                                                ...
                                                <td class="align-middle text-center">[[ format.apellidos_nino ]]</td>
                                                ...
                                                <td class="align-middle text-center">[[ format.NOMBRE_EESS_NACIMIENTO ]]</td>
                                                <td class="align-middle text-center">[[ format.Lugar_TMZ ]]</td>
                                                <td class="align-middle text-center">[[ format.FECHA_ATENCION ]]</td>
                                                <template v-if="format.TAMIZADO == 'SI'">
