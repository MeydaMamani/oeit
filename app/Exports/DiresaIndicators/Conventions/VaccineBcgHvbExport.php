...
class VaccineBcgHvbExport implements FromView, ShouldAutoSize
{
    protected $nominal;
    protected $anio;
    protected $nameMonth;
    ...
    public function view(): View {
        ...
        return view('diresaIndicators.Conventions.VaccineBcgHvb.print', [ 'bcgHvb' => $nominal_f, 'anio' => $a, 'nameMonth' => $name ]);
    }
}